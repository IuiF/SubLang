 ...
 * by extracting arguments from TranslatableComponent and applying them to the
...
public final class TranslationResolver {
    ...
    private static String resolveToSourceLanguage(Component component, int depth) {
        ...
        if (component instanceof TranslatableComponent translatable) {
            return resolveTranslatableComponent(translatable, depth);
        }

        // For non-translatable content (TextComponent, etc.),
        // return the string representation as-is
        return component.getString();
    }

    /**
     * Resolve a TranslatableComponent to its source language equivalent.
     */
    private static String resolveTranslatableComponent(TranslatableComponent component, int depth) {
