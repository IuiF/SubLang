...
public class NameFormatter {
     ...
     */
    public static ITextComponent formatItemName(ItemStack stack, ITextComponent currentName) {
     ...
     */
    private static ITextComponent formatBilingual(ITextComponent currentName, String sourceTranslation) {
        ...
        IFormattableTextComponent result = new StringTextComponent(formatted);
     ...
     */
    public static ITextComponent formatWithStyledSource(ITextComponent currentName, String sourceTranslation) {
        IFormattableTextComponent result = new StringTextComponent("");
        result.append(currentName);
        result.append(new StringTextComponent(" ("));
        result.append(new StringTextComponent(sourceTranslation).withStyle(TextFormatting.GRAY));
        result.append(new StringTextComponent(")"));
        return result;
    }
}
